package com.xlz.quickjs.method;
...
import com.xlz.quickjs.bean.Req;
import com.xlz.quickjs.utils.Connect;
import com.xlz.quickjs.utils.Crypto;
import com.xlz.quickjs.utils.HtmlParser;
import com.xlz.quickjs.utils.JSUtil;
...
public class Global {
    ...
    @Keep
    @JSMethod
    public JSArray pdfl(String html, String p1, String list_text, String list_url, String add_url) {
        return JSUtil.toArray(ctx, HtmlParser.parseDomForList(html, p1, list_text, list_url, add_url));
    }
