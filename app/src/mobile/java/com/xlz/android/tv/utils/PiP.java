package com.xlz.android.tv.utils;
...
import com.xlz.android.tv.event.ActionEvent;
import com.xlz.android.tv.receiver.ActionReceiver;
...
public class PiP {
    ...
    public void update(Activity activity, boolean play) {
        try {
            ...
            actions.add(buildRemoteAction(activity, com.xlz.android.tv.R.drawable.ic_action_audio, R.string.exo_controls_hide, ActionEvent.AUDIO));
