...
import com.xlz.android.tv.bean.Backup;
...
import com.xlz.android.tv.db.dao.ConfigDao;
import com.xlz.android.tv.db.dao.DeviceDao;
import com.xlz.android.tv.db.dao.HistoryDao;
import com.xlz.android.tv.db.dao.KeepDao;
import com.xlz.android.tv.db.dao.LiveDao;
import com.xlz.android.tv.db.dao.SiteDao;
import com.xlz.android.tv.db.dao.TrackDao;
import com.xlz.android.tv.utils.FileUtil;
import com.xlz.android.tv.utils.Formatters;
import com.xlz.android.tv.utils.Task;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static void backup() {
        backup(new com.xlz.android.tv.impl.Callback());
    }

    public static void backup(com.xlz.android.tv.impl.Callback callback) {
        Task.execute(() -> {
    ...
    public static void restore(File file, com.xlz.android.tv.impl.Callback callback) {
        Task.execute(() -> {
